...
const GeneralChannel = () => {
    const channel = COMMUNITY_DASHBOARD_DATA.channels.find(c => c.id === 'general');
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 p-6 space-y-6">
                ...
                <div className="flex gap-4 group">
                    <div className="w-10 h-10 rounded-full bg-zinc-700 flex-shrink-0 flex items-center justify-center text-lg">
                        👩‍💻
                    </div>
                    <div>
                        ...
                        <p className="text-gray-300">Anyone working on any cool projects this week?</p>
                    </div>
                </div>
                <div className="flex gap-4 group">
                    <div className="w-10 h-10 rounded-full bg-zinc-700 flex-shrink-0 flex items-center justify-center text-lg">
                    ...
                    <div>
                        ...
                        <p className="text-gray-300">Working on a real-time chat app with WebSockets! Pretty fun so far 🚀</p>
                    </div>
                </div>
            </div>
