...
const LandingPage = () => {
    ...
    const features = [
        { icon: <Zap className="text-yellow-400" />, title: "Smart Feed & Semantic Search", desc: "No more information overload. Our AI curates events based on your academic profile and interests, while Gemini-powered search lets you query naturally." },
